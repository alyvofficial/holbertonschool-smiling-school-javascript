document.addEventListener("DOMContentLoaded", function() {
    ...
    const carouselInner2 = document.querySelector('#carouselExampleControls2 .carousel-inner');
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 d-flex justify-content-center">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text text-muted">${tutorial.sub_title}</p>
                  ...
                  <div class="info pt-3 d-flex justify-content-between">
                    <div class="rating">
                      ${[...Array(5)].map((_, i) => `<img src="images/${i < tutorial.star ? 'star_on' : 'star_off'}.png" alt="star" width="15px" />`).join('')}
                    </div>
